...
// AdminGetOrders возвращает список заказов с пагинацией
...
// AdminGetOrder возвращает детали конкретного заказа
...
// AdminUpdateOrderStatus обновляет статус заказа
...
// AdminUpdateOrder обновляет заказ

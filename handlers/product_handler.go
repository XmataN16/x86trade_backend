...
// AdminGetProducts — возвращает список всех продуктов.
...
// AdminCreateProduct — создаёт продукт.
// JSON: { "name":"...","sku":"...","description":"...","price":123.45,"category_id":1,"manufacturer_id":2 }
...
// AdminUpdateProduct — обновляет продукт по id (в теле те же поля).
...
// AdminDeleteProduct — удаляет продукт по id.
